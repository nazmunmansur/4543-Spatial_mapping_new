...
- [ ] **Spatial Representations**
  - [ ] Points, lines, polygons (vector thinking)
  - [ ] Raster vs vector (conceptual only)
  - [ ] Abstraction vs reality

- [ ] **Coordinates & Reference**
  - [ ] Longitude / latitude (geographic coordinates)
  - [ ] Why reference systems matter
  - [ ] When coordinate systems break analysis
  - [ ] (Later) projected vs geographic thinking

- [ ] **Distance, Space, and Measurement**
  - [ ] Straight-line vs path-based distance
  - [ ] Campus-scale vs world-scale distance
  - [ ] When distance is misleading

- [ ] **Extent, Scale, and Resolution**
  - [ ] Bounding boxes and spatial limits
  - [ ] What gets included vs excluded
  - [ ] Resolution as a design decision
  - [ ] Scale as interpretation, not zoom

- [ ] **Spatial Data Formats**
  - [ ] GeoJSON as a learning format
  - [ ] CSV + coordinates
  - [ ] Conceptual overview of shapefiles & rasters
  - [ ] Metadata and provenance (why it matters)

- [ ] **Working with Real Spatial Data**
  - [ ] Reading and validating raw files
  - [ ] Cleaning and sanity-checking spatial data
  - [ ] Data quality, accuracy, and uncertainty

- [ ] **Spatial Relationships & Queries**
  - [ ] Containment, intersection, proximity
  - [ ] Nearest neighbor thinking
  - [ ] Topology as rules, not magic

- [ ] **Spatial Analysis (Concept-First)**
  - [ ] Buffers, clipping, overlays
  - [ ] Spatial joins (why they work)
  - [ ] Raster analysis (high-level intuition)

- [ ] **Visualization as Argument**
  - [ ] Maps as communication, not truth
  - [ ] Symbolization and color choices
  - [ ] Ethical and misleading maps

- [ ] **Interactive & Programmatic Mapping**
  - [ ] Data → map pipelines
  - [ ] Client vs server thinking
  - [ ] APIs and libraries (conceptual)
  - [ ] Automation and reproducibility

- [ ] **Scaling & Performance (Awareness Level)**
  - [ ] Why spatial data gets slow
  - [ ] Indexing as an idea
  - [ ] Precision vs performance tradeoffs

- [ ] **Time, Change, and Simulation** (time permitting)
  - [ ] Temporal spatial data
  - [ ] Movement and change over time
  - [ ] Simple spatial simulations

- [ ] **Applied Spatial Thinking**
  - [ ] Case studies (urban, environmental, routing)
  - [ ] End-to-end spatial pipeline
  - [ ] Capstone / final project

## Calendar

| Week | Dates (Approx)  | Focus / Topic Area               | Major Assignment or Milestone                       |
| ---: | --------------- | -------------------------------- | --------------------------------------------------- |
|    1 | Dec 20 – Dec 27 | ❄️ Course disruption             | No content (weather / orientation)                  |
|    2 | Dec 28 – Jan 10 | Dev Environment & Workflow       | **00-Dev_Environment** (setup, Codespaces, Jupyter) |
|    3 | Jan 11 – Jan 17 | Raw Spatial Data                 | **01-Raw_Spatial_Data** begins                      |
|    4 | Jan 18 – Jan 24 | GeoJSON & Spatial Structure      | **00-Hello_GeoJSON** (Mini-Lab)                     |
|    5 | Jan 25 – Jan 31 | Points, Lines, Polygons          | Project 01 work continues                           |
|    6 | Feb 1 – Feb 7   | Distance, Paths, Extent          | **Project 01 Due**                                  |
|    7 | Feb 8 – Feb 14  | Review & Synthesis               | **Midterm Exam**                                    |
|    8 | Feb 15 – Feb 21 | Spatial Fundamentals             | **02-Spatial_Fundamentals** begins                  |
|    9 | Feb 22 – Feb 28 | Scale, Resolution, Bounding      | Project 02 work                                     |
|   10 | Mar 1 – Mar 7   | Coordinate Systems (Conceptual)  | **Project 02 Due**                                  |
|   11 | Mar 8 – Mar 21  | Spatial Analysis & Visualization | **03-Spatial_Analysis_Project**                     |
|   12 | Mar 22 – Apr 11 | Real-World Datasets & Mapping    | Final Project development                           |
|   13 | Apr 12 – May 8  | Integration & Wrap-Up            | **Final Project + Final Exam**                      |

## Grading

| Categories                              | Weight |     | Letter Grade | Grade Range |
| :-------------------------------------- | :----: | :-: | :----------: | :---------- |
| Exams (2)<sup>**1**</sup>               | ⇦ 45%  |     |     A ⇨      | 90-100      |
| Assignments (notebooks)<sup>**2**</sup> | ⇦ 25%  |     |     B ⇨      | 80-89       |
| Quizzes                                 | ⇦ 20%  |     |     C ⇨      | 70-79       |
...
>
> **Note<sup>2</sup>** - Miscellaneous includes: Programs, Quizzes, Assignments, ... anything not in its own category.
>
